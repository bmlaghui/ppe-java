...
public abstract class Appartenir implements Comparable<Appartenir>, Serializable
{
    @Id
	...
	Appartenir(Inscriptions inscriptions, String nom)
	{
	...
	@Override
	public int compareTo(Appartenir o)
	{
